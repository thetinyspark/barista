...
export default class PathFinder3D {
    ...
    public createGraphe(grid:Grid3D<number>, walkableValue:number):Grid3D<GameNode>{
        const graphe = new Grid3D<GameNode>();
    ...
    public resetGraphe(graphe:Grid3D<GameNode>):void{
        this.opened = new Array();
        this.closed = new Array();
        graphe.forEach( 
            (node:GameNode, row:number, col:number, layer:number)=>{
    ...
    public findPath(graphe:Grid3D<GameNode>, startNode:GameNode, endNode:GameNode, allowDiagonals:boolean = false): GameNode[] {
        ...
        while (hasNextStep) {
            ...
            const neighbours = [
                ...
                graphe.getLeft(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                graphe.getRight(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                graphe.getTop(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                graphe.getBottom(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                graphe.getBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                graphe.getFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
            ];

            if( allowDiagonals ){
                neighbours.push(
                    graphe.getTopLeftBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getTopRightBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getBottomLeftBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getBottomRightBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer),

                    graphe.getTopLeftFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getTopRightFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getBottomLeftFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getBottomRightFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer),

                    graphe.getTopLeft(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getTopRight(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getBottomLeft(currentNode.state.row, currentNode.state.col, currentNode.state.layer),
                    graphe.getBottomRight(currentNode.state.row, currentNode.state.col, currentNode.state.layer)
                )
            }
            ...
            nonEmpty.forEach(
                (node)=>{
                    ...
                    const newH = (
                        Math.abs(endNode.state.row - node.state.row) + 
                        Math.abs(endNode.state.col - node.state.col) +
                        Math.abs(endNode.state.layer - node.state.layer)
                    ) * NODE_DISTANCE_VALUE;
