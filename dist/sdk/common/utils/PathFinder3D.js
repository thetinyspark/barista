...
class PathFinder3D {
    ...
    createGraphe(grid, walkableValue) {
        ...
        grid.forEach((value, row, col, layer) => {
    ...
    resetGraphe(graphe) {
        ...
        graphe.forEach((node, row, col, layer) => {
            if (node) {
                node.state.row = row;
                node.state.col = col;
                node.state.layer = layer;
    ...
    findPath(graphe, startNode, endNode, allowDiagonals = false) {
        ...
        while (hasNextStep) {
            ...
            if (allowDiagonals) {
                neighbours.push(graphe.getTopLeftBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getTopRightBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getBottomLeftBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getBottomRightBack(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getTopLeftFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getTopRightFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getBottomLeftFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getBottomRightFront(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getTopLeft(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getTopRight(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getBottomLeft(currentNode.state.row, currentNode.state.col, currentNode.state.layer), graphe.getBottomRight(currentNode.state.row, currentNode.state.col, currentNode.state.layer));
            }
            ...
            nonEmpty.forEach((node) => {
                ...
                const newH = (Math.abs(endNode.state.row - node.state.row) +
                    Math.abs(endNode.state.col - node.state.col) +
                    Math.abs(endNode.state.layer - node.state.layer)) * exports.NODE_DISTANCE_VALUE;
